          ...
          points: [
            {
              tag: '结论一',
              label: '组织杀死执行力',
              evidence: '14/22 份访谈独立指向同一判断——"AI 能力 ≤80 分可用、>80 分不行"；中台缺失导致航道各自建基建，Token 预算 40-60 万/年覆盖 150 人（≈ 4000 元/人/年）。一线证言：签零团队 AI 使用完全"个人自费探索"，组织层零供给———与家人共用 MiniMax 基础账号；战略 BP 直指acme"半死不活"三叠加：硬编码 × 刻舟求剑 × 产品经理需求承接型。成都研发—印证：AI coding去年10月试点→今年4月才全面推开，一线渴望统一企业AI平台（"像飞书那样的平台"），但组织层无供给',
              source: '— · — · — · — · — · — · 李崧 · —',
            ...
            },
            {
              tag: '结论二',
              label: '增长曲线断裂',
              evidence: 'acme外部收入占比 20-36%，目标 3-5 年跃至 50%，中间缺阶梯路径。签零团队实况：5000 万/年营收、10 个客户做 10 套产品、客单价 5000 元到 200 万元无定价规则——"为了平而平"。战略 BP 诊断：acme"完全没有发现 Under-serve 需求的能力"，这才是未来 2-3 年成败关键。财务—确认：Q1整体亏损2700万/现金流-1900万，仅安心BU（硬件）盈利但规模从1亿萎缩至5-6千万，软件业务缺清晰产品线——"没有标准化的产品线体系，多数为衍生性需求"',
              source: '— · — · — · — · — · 李崧 · —',
            ...
            },
            {
              tag: '结论四',
              label: '两三年窗口期',
              evidence: '序平总原话"acme只有两三年窗口期"+"算力窗口半年到一年"；—判断物理空间 AI 窗口 2026-2028；战略 BP 判断约 1 年——"当通用 AI 工具成熟后acme先发优势消失"；CEO 公开授权"航道总 AI 素养不过关就换掉"；CHO"CTO+CHO 合力推否则必败"。—一线验证：AI coding半年才从试点走到全面推开，复杂业务场景仍在第三→第四阶段过渡——窗口期内组织提速刻不容缓',
              source: '序平总 · — · — · 李崧 · —',
