...
const app = createApp({
  setup() {
    ...
    const SECTION_TAXONOMY = [
      {
        key: '01-diagnosis',
        label: '内部诊断',
        subtitle: '自下而上的acme全景判断',
        tagline: '31 份一线访谈 · 三层诊断 · 10 条横截面洞察',
        icon: '🔬',
        tier: 'primary',
        narrative: [
          { stage: '目标', label: '诊断目的', desc: '全面摸清acme组织能力、业务水位与战略空白', color: 0 },
          ...
          { stage: '收官', label: '战略衔接', desc: '组织瓶颈 → Flagship 组织变革，增长卡点 → acme战略总图', color: 4 },
        ],
        entities: [
          { key: '10-管理层', label: '集团管理层', desc: '集团CEO·CHO·一体三翼战略决策层', icon: '🏛️' },
          { key: '20-航道', label: 'C1-C5航道 / N1-N3创新', desc: '开发·商业·冠寓·物业·运营 + acme·品牌优选', icon: '🌊' },
          { key: '30-BU', label: 'acme八大BU', desc: '智慧空间·建造·资管·城服·IDC·AI创新·营销·运营', icon: '🎯' },
          ...
          points: [
            {
              tag: '结论一',
              label: '组织杀死执行力',
              evidence: '18/30 份访谈独立指向同一判断——"AI 能力 ≤80 分可用、>80 分不行"；中台缺失导致航道各自建基建，Token 预算 40-60 万/年覆盖 150 人（≈ 4000 元/人/年）。一线证言：签零团队 AI 使用完全"个人自费探索"，组织层零供给———与家人共用 MiniMax 基础账号；战略 BP 直指acme"半死不活"三叠加：硬编码 × 刻舟求剑 × 产品经理需求承接型。成都研发—印证：AI coding去年10月试点→今年4月才全面推开，一线渴望统一企业AI平台（"像飞书那样的平台"），但组织层无供给。供应链—印证：团队Co-pilot/Claude已"不离手"，但与AI团队协作"没头苍蝇"，遵循"能不用大模型就不用大模型"——一线已有正确直觉，缺平台承接。董事长汇报(4/16)新增证据：— AI 产研平台路径获认可·—提出「专家智能体必须达到 P7 高级专业工程师水平、少而精、规避大而全」——质量标准进一步拉高；合同审查 700+ 类型已成规模（南通客户评价"做得非常细"）',
              source: '— · — · — · — · — · — · 李崧 · — · — · —(董事长) · — · —',
              arrow: 'Flagship · 让每个同事几分钟用上最好的AI + Secondary 统一底座',
              accent: '#f59e0b'
            },
            {
              tag: '结论二',
              label: '增长曲线断裂',
              evidence: 'acme外部收入占比 20-36%，目标 3-5 年跃至 50%，中间缺阶梯路径。签零团队实况：5000 万/年营收、10 个客户做 10 套产品、客单价 5000 元到 200 万元无定价规则——"为了平而平"。战略 BP 诊断：acme"完全没有发现 Under-serve 需求的能力"，这才是未来 2-3 年成败关键。财务—确认：Q1整体亏损2700万/现金流-1900万，仅安心BU（硬件）盈利但规模从1亿萎缩至5-6千万，软件业务缺清晰产品线——"没有标准化的产品线体系，多数为衍生性需求"。董事长汇报(4/16)新增证据：AI慧眼三大市场方向获认可——老旧小区（物业费降至 ¥0.6-0.7/㎡，政策补贴窗口）+ 工业/行政消防 + 渠道合作（住建部/物业协会/电信二级）；demo 十一首发长营天街+重庆时代天街(集团租金#1#2) 直接对赌增长。智慧空间BU交付负责人陈路广(4/17)正面印证：亲口承认"卖一单是一单模式未来不可持续、订阅化是必然方向"，并完整接受CTO提出的Spatial Agent OS/开源闭源结合/对标Cursor-Vercel/B2C线下VR门店/barfoo游戏化方案——CTO订阅化愿景在BU一号位层首次获得正面接收',
              source: '— · — · — · — · — · 李崧 · — · —(董事长) · —(demo) · 陈路广(空间BU交付)',
              arrow: 'Track 2 · acme空间智能引擎',
              accent: '#ef4444'
            },
            {
              tag: '结论三',
              ...
              source: '— · 李崧 · — · — · — · — · — · —',
              arrow: 'Flagship 人才密度重建 + acme AI 课分层 + Best Practice v0.1',
              accent: '#8b5cf6'
            },
            {
              tag: '结论四',
              label: '两三年窗口期',
              evidence: '序平总原话"acme只有两三年窗口期"+"算力窗口半年到一年"；—判断物理空间 AI 窗口 2026-2028；战略 BP 判断约 1 年——"当通用 AI 工具成熟后acme先发优势消失"；CEO 公开授权"航道总 AI 素养不过关就换掉"；CHO"CTO+CHO 合力推否则必败"。—一线验证：AI coding半年才从试点走到全面推开，复杂业务场景仍在第三→第四阶段过渡——窗口期内组织提速刻不容缓。董事长汇报(4/16)⭐ 首次落地窗口：demo 十一窗口死线(2026-10-01)——董事长已批"长营先跑通、重庆时代同步"、大会员开发资源并入、bar闭环禁外部兑换·A/B面整合超A；造价业务董事长点名"先先弄造价、成为行业第一个把工程造价全部智能体化"+"已跟裴总打招呼"——两大项目同步进入落地窗口',
              source: '序平总(董事长) · — · — · 李崧 · — · —(demo) · —(造价)',
              arrow: 'acme战略总图 · 四股力量首次对齐 · 全速推进',
              accent: '#06b6d4'
            },
          ]
        }
      },
      {
        ...
        narrative: [
          ...
          { stage: '结论', label: '外部判据', desc: '竞争饱和度 · acme基因匹配度 · 窗口期 · TAM', color: 2 },
          { stage: '处方', label: '战略建议', desc: '基于外部判据，acme应选哪条路——能力要求 · 窗口期 · 关键决策点', color: 3 },
        ...
        conclusions: {
          ...
          points: [
            ...
            },
            {
              tag: '判据二',
              label: 'acme基因不可复制',
              evidence: 'acme IoT：1000 万+设备在线 / 99% 品牌覆盖 / 日吞吐 1 亿条 / 350+ 设备类型——2000+ 社区 + 100 座天街 + 16 万间冠寓 + 163 城 840 万家庭的室内 3D 数据，Google 也拿不到',
              source: 'acme IoT · foo会员 9000 万 / 2000 万 MAU',
              arrow: 'Secondary 五位一体开源基础设施',
              accent: '#10b981'
            },
            {
              tag: '判据三',
              ...
              arrow: 'Track 3A · foo世界 · 物理 MR 乐园连锁',
              accent: '#8b5cf6'
            },
            {
              tag: '判据四',
              label: 'C 端超级入口有验证',
              evidence: 'Bilt 仅靠"租金支付变积分"一个点估值 $107.5 亿、年化处理 $1000 亿——acme三航道闭环（冠寓+天街+物业）ID 打通后 TAM ≈ ¥6000 亿，全球 Space-Native Life OS 无对标',
              source: 'Bilt Series E · foo会员 · 三航道数据',
              arrow: 'Track 3B · demo · 手机原生超级入口',
              accent: '#06b6d4'
            },
          ]
        }
      ...
      {
        key: '04-triad',
        label: 'acme第二曲线 · acme战略总图',
        subtitle: '一个引擎 · 三条赛道 · 六大底盘',
        tagline: 'acme空间智能引擎 · foo世界 DemoWorld · 示例 demo',
        icon: '⚜️',
        tier: 'flagship',
        finale: {
          ...
          forecast: {
            ...
            tracks: [
              ...
              { key: 't3a', label: 'Track 3A · DemoWorld', color: '#ff9e7a', values: [0.2, 1.5, 5, 10, 18] },
              { key: 't3b', label: 'Track 3B · demo', color: '#c48eff', values: [0.3, 2, 5, 15, 35] },
            ],
            curves: [
              { code: 'Curve 1', name: '门店体验', y5: 12, ps: '7×', ev: 84, asset: '100 天街物理空间' },
              { code: 'Curve 2', name: 'IP生态', y5: 6, ps: '10×', ev: 60, asset: '28 年运营 Know-how' },
              { code: 'Curve 3', name: '会员订阅', y5: 10, ps: '12×', ev: 120, asset: 'foo 9000 万注册 · 2000 万月活' },
              ...
              { code: 'Curve 6', name: '硬件+IoT+Secondary', y5: 4, ps: '5×', ev: 20, asset: '1000 万+设备 · 五位一体开源底座' },
          ...
          // 六大底盘资产（底盘 B1-B6）
          curves: [
            { code: 'B1', name: 'Secondary 空间智能底座', desc: '五位一体：long-sida(3D) + long-cozy(家居) + long-navi(VPS) + long-mira(世界模型) + long-boot(具身)' },
            { code: 'B2', name: '三航道物理空间产权', desc: '100 天街 + 2000+ 社区 + 16 万冠寓 · 全球无第二家同时拥有商业+住宅+租赁三类真实空间' },
            { code: 'B3', name: 'acme IoT 设备网络', desc: '1000 万+设备在线 / 99% 品牌覆盖 / 日吞吐 1 亿条 / 350+ 设备类型 · 十年百亿级投入' },
            { code: 'B4', name: 'foo跨业态身份体系', desc: '9000 万注册 / 2000 万月活 · 三航道 ID 打通后覆盖租住消费全生命周期' },
        ...
        narrative: [
          { stage: '筛选', label: '赛道筛选逻辑', desc: 'Top5 → 收敛至 Track 1 稳存量 + Track 2 acme空间智能引擎 + Track 3 双引擎', color: 0,
            stageMatcher: ['战略架构', '市场判断', '核心约束'] },
          { stage: 'Track1', label: '稳存量守成', desc: '守住acme现金流基本盘 · AI 提效存量航道 C1-C5', color: 1,
            stageMatcher: ['稳存量', 'Track 1', 'AI提效', '存量航道'] },
          { stage: 'Track2', label: 'acme空间智能引擎 · ToB 旗舰', desc: '新商业引擎完整战略 + Secondary 开源框架（long-sida/cozy/navi/mira/boot）', color: 2,
            stageMatcher: ['Secondary', 'long-sida', 'long-cozy', 'long-navi', 'long-mira', 'long-boot', '开源', '五位一体', '空间智能引擎'] },
          { stage: 'Track3A', label: 'foo世界 DemoWorld · 线下网络', desc: '5 Zone MR+AR体验空间 · 软件定义场景 · 轻资产快部署 · 线下网络', color: 3,
            stageMatcher: ['foo世界', 'DemoWorld', '5 Zone', '美好之门', 'MR'] },
          { stage: 'Track3B', label: '示例 demo ToC 旗舰 · 线上入口', desc: 'Space-Native Life OS 首超级入口 · Proactive Life Agent 主引擎 · 手机原生 · 线上入口 · 100万DAU目标', color: 4,
            stageMatcher: ['示例', 'demo', 'Life OS', '超级入口', 'Proactive'] },
          { stage: '底盘', label: '六大底盘 + Secondary 五位一体', desc: 'B1 Secondary 技术底座（long-sida/cozy/navi/mira/boot 开源）/ B2 三航道物理产权 / B3 acme IoT / B4 foo身份 / B5 28年 Know-how / B6 163城数据闭环', color: 5,
            stageMatcher: ['护城河', '底盘', 'IoT', '产权', 'foo身份', 'Secondary', 'long-sida', 'long-cozy', 'long-navi', 'long-mira', 'long-boot', '五位', '开源', '飞轮', 'IC复活', 'GPU'] },
        ...
        entities: [
          ...
          { key: 'projects', label: '旗舰项目战略提案', desc: 'acme空间智能引擎 · foo世界 DemoWorld · 示例 demo', icon: '🚀' },
        ]
      },
      {
        key: '03-flagship',
        ...
        bloom: true,
        narrative: [
          { stage: '为什么', label: '为什么需要 Flagship', desc: '内部AI能力碎片化 → 每个BU各自建轮子 → 需要统一的AI可用性服务', color: 0,
      ...
      },
      {
        ...
        narrative: [
          ...
          { stage: '主线', label: 'ARR 核心目标主线', desc: 'acme3年/5年ARR目标曲线 · 每个Track贡献多少 · 关键里程碑月份', color: 1,
            stageMatcher: ['核心目标一句话', '一句话', '总表', 'ARR', '稳存量', 'PropertyMind', 'foo世界', 'Track 1', 'Track 2', 'Track 3'] },
          ...
          { stage: '反核心目标', label: '我们承诺不做的事', desc: '反核心目标清单 · 红线 · 缺失数据清单', color: 4,
            stageMatcher: ['反核心目标', '反向', '红线', '承诺不做', 'Anti', '缺失数据'] },
        ],
        entities: []
      },
      {
    ...
    // Keys come from filename prefix before first ·, e.g. "acmeBU-智慧建造-—"
    const PERSON_DISPLAY_MAP = {
      // Unified 层级/类别-人名 format (matches doc title convention)
      'acmeBU-智慧空间-—':       'acme/智慧空间BU-—',
      'acmeBU-智慧建造-—':       'acme/智慧建造BU-—',
      'acmeBU-智慧建造-—团队':   'acme/智慧建造BU-—团队',
      'acmeBU-智慧资管-—':       'acme/智慧资管BU-—',
      'acmeBU-智慧IDC-—':      'acme/智慧IDC BU-—',
      'acmeBU-——':          'acme/IDC+大会员-——',
      'acmeBU-AI创新-—':       'acme/AI创新BU-—',
      'acmeHRD+运营-——':    'acme/HRD+运营-——',
      '李崧':                        'acme/战略BP-李崧',
      '—':                        'acme/CEO-—总',
      '—·—':                 'acme/IDC+大会员-—·—',
      'C1供应链':                    '航道/C1供应链-阶段诊断',
      ...
      'C4空间服务':                  '航道/C4空间服务-处方',
      'acme财务-—':            'acme/财务-—',
      'acme建管BU-—':            'acme/建管BU供应链-—',
      'acmeBU-物管BU成都研发-—': 'acme/物管BU成都-—',
      'acmeBU-智慧物业-—':       'acme/智慧物业BU-—',
      'acmeBU-智慧DTC-——': 'acme/智慧DTC BU-—×—',
      'acmeBU-智慧DTC-—':     'acme/智慧DTC BU-—',
      'acme战略-——·acme产研架构总图': 'acme/战略-acme产研架构总图',
      'acme战略-———':            'acme/战略-企业智能体平台',
      'acmeBU-智慧空间-———':       'acme/智慧空间BU-AI慧眼',
      'acmeBU-智慧DTC-———':        'acme/智慧DTC BU-demo',
      'acme战略-———':            'acme/战略-AInative企业能力',
      'acme战略-——':                  'acme/战略-产研架构总图主档(—×—主持)',
      // 旧拆分命名（向后兼容历史报告引用）
      'acmeBU-智慧DTC-——': 'acme/智慧DTC BU-demo',
      'acmeBU-智慧空间-——': 'acme/智慧空间BU-AI慧眼(董事长评价)',
      'acme战略-——':       'acme/战略-产研架构总图(董事长汇报)',
      'acme战略-——':     'acme/战略-AI产研平台(董事长评价)',
      '集团研发设计-—':         '集团/研发设计-—',
      'C1供应链-——':       '航道/C1供应链-—×—(造价)',
      ...
      '—': 'acme/智慧空间BU-—',      '—': 'acme/智慧建造BU-—',
      '—团队': 'acme/智慧建造BU-—团队',
      '—': 'acme/智慧资管BU-—',      '—': 'acme/智慧IDC BU-—',
      '—': 'acme/AI创新BU-—',    '——': 'acme/HRD+运营-——',
      '—·—': 'acme/HRD+运营-——',
      '—': 'acme/CEO-—总',          '—': '集团/CHO-—总',
      '—': '航道/C1供应链-—',       '—': '航道/C2商业-—',
      '—': '航道/C5智慧营造-—',  '—': '航道/N2品牌优选-—',
      ...
      '—': '集团/研发设计-—',
      '——': 'acme/智慧DTC BU-—×—',
      '——': 'acme/战略-AI产研平台(董事长评价)',
      '——': 'acme/智慧空间BU-AI慧眼(董事长评价)',
      '——': 'acme/战略-董事长汇报',
      '——': 'acme/战略-—×—',
      '———': 'acme/智慧DTC BU-—×—×—(demo)',
      '———': 'acme/战略-—×—×—(企业智能体)',
    ...
    const expandedTrack = ref('track1'); // acme战略总图 默认展开第一条
    ...
    const cockpitBlocks = computed(() => {
      ...
      const order = ['01-diagnosis','02-research','03-flagship','04-secondary','05-metrics','04-triad','99-roadmap','99-archive','00-personal'];
      const wanted = new Set(['01-diagnosis','02-research','03-flagship','04-secondary','04-triad','05-metrics']);
      return order
    ...
    // Bloom master doc (for Flagship / 核心目标)
    ...
    async function loadCockpit() {
      ...
      cockpitError.value = '';
      try {
        const r = await fetch('/api/acme/cockpit');
    ...
    function openCockpitExport() {
      window.open('/api/acme/cockpit/export', '_blank');
    }

    async function downloadCockpitHtml() {
      try {
        const r = await fetch('/api/acme/cockpit/export');
        ...
        a.href = url;
        a.download = `acme-cockpit-${stamp}.html`;
    ...
    async function openCockpitEditor() {
      try {
        const r = await fetch('/api/acme/cockpit/raw');
        const d = await r.json();
    ...
    async function saveCockpitRaw() {
      ...
      try {
        const r = await fetch('/api/acme/cockpit/save', {
          method: 'POST',
    ...
    const orgExpandedNodes = ref(new Set(['root','group-mgmt','c-channels','n-channels','acme']));
    ...
    const orgTree = [
      { key: 'root', label: 'acme集团', icon: '🏛️', accent: '#c8a96e', children: [
        // 集团管理战略（最上面）
        ...
        { key: 'group-platforms', label: '集团十大平台', icon: '🧩', accent: '#7ae8c0', desc: '集团横向平台体系 · 非acme · 共 10 个', children: [
        ...
        // N1-N3 创新航道
        { key: 'n-channels', label: 'N1-N3 创新航道', icon: '🚀', accent: '#c48eff', desc: '创新孵化 · acme为N1', children: [
          { key: 'n1', label: 'N1 · acme数科', icon: '🧭', accent: '#e7b85a', tag: '科技子公司', ref: 'acme' },
        ...
        // acme数科（N1展开）
        { key: 'acme', label: 'acme数科', icon: '🧭', accent: '#e7b85a', desc: 'CEO — · CTO — · N1创新航道实体 · 目标逐步对外', children: [
    ...
    const titles = {dashboard:'全景',tasks:'清单',plan:'365天作战地图',insights:'洞察 · 从你的碎片里看见未来',life:'生活 · 与家人和自己好好相处',cockpit:'acme · 战略驾舱',notes:'速记',reflections:'反思',contacts:'组织架构',memory:'记忆',growth:'养成',interviews:'访谈',reports:'汇报',files:'文件',settings:'设置'};
    ...
    const ASR_FIXES = [
      ...
      [/淮阳/g, '—'], [/X/g, '—'], [/怀润/g, '—'],
      [/龙丽君/g, '—'],
      [/景优/g, '实例'], [/静优/g, '实例'], [/金优/g, '实例'],
      [/千金智能/g, 'acme互联'], [/C22化/g, 'C2I化'],
      ...
      [/龙骨味/g, 'acme味'], [/清量化/g, '轻量化'],
      [/示例工具(?![a-zA-Z])/g, 'Vercel'],
    ...
    async function loadASRFromEEG(tenant = 'acme') {
      try {
    ...
    const KNOWN_INSIGHTS = {
      'C端空间智能创新落地研讨': {
        ...
        keySignals: [
          { icon: '🎯', title: '天然盟友锁定', text: '—总管大会员+APP+foo积分+用户运营IP——正好是示例(Track 3B)的四根柱子。资深，组织脉络/预算路径/跨航道协调极其熟悉。' },
          { icon: '🗺️', title: '四大场景 = foo世界5 Zone', text: '商场AR(Zone 1) / 家装可视化(Zone 2) / 社区智能体(Zone 3) / 跨场景生态(全域)——业务侧独立看到了同样的机会，且愿意投入。' },
        ...
        consensus: [
          { icon: '🤝', text: 'acme线下空间 = 虚实结合差异化的唯一底牌' },
    ...
    const KNOWN_SPEAKER_MAPS = {
      ...
      '陈路广·产品标准化与AI空间智能底座': {
        // SPEAKER_00 自述：Java后端入职acme→重福外拓→城投→运营→今年调空间做项目交付（陈路广履历）
        // SPEAKER_01 提问方（—）
      ...
      '产研架构总图与四项目汇报': {
        'SPEAKER_00': '—（acmeCEO·主持·acme总图）',
        'SPEAKER_01': '—（董事长·评价者）',
        'SPEAKER_02': '—（AI创新BU·企业智能体）',
        'SPEAKER_03': '—（智慧空间BU·AI慧眼）',
        'SPEAKER_04': '—（CTO·demo C端）',
      ...
      '物业机器人VR驾舱': {
        ...
        //   ⚠️ 2026-04-17 全量审计确认：文中"X总"是 ASR 对"—总"的误读
        //      （"北大本硕 CS/CV/空间模型""1 天手搓"均为—独家履历）。已在 ASR_FIXES 统一替换。
        //      frontmatter 明确—在场，不是"X=另一位天津新任 CTO"。
        'SPEAKER_01': '—（C2资管）',
        'SPEAKER_02': '—（C2商业）',
    ...
    async function openInterview(file, opts={}){
      ...
      const tagLines = rawSummary.split('\n').filter(l => {
        const t = l.trim();
        return t.length > 0 && t.length < 15 && !/^\d|^[|/]|Shadow|TicNote|新功能|编辑|总结|转录|思维导图|顿悟|深度研究|播客|\.m4a|acme|出席/.test(t) && !/^[\u{1F000}-\u{1FFFF}]/u.test(t);
      });
      // Extract speakers
