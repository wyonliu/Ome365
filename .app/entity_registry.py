...
if __name__ == "__main__":
    ...
    sample = "示例A总提了一下，让示例B和示例C去跟进下 C1 的事。Claude Code 已经用上了 示例工具。"
    print(json.dumps(resolve(sample, tenant="acme"), ensure_ascii=False, indent=2))
